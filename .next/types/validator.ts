...
// Validate ../../src/app/api/territories/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/territories">> = Specific
  const handler = {} as typeof import("../../src/app/api/territories/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
