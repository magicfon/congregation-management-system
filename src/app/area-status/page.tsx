...
export default function AreaStatusPage() {
  ...
  return <DashboardLayout><div className="max-w-[1600px] mx-auto p-4 md:p-6 space-y-3 text-mc-text">
    ...
    {data && !loading && <>
      ...
      <AreaStatusMap data={data} selectedId={selectedId} onSelect={setSelectedId} />
