...
<header><h1>三區地圖分區重建草稿</h1><a href="/tools/boundary-editor/index.html" style="display:inline-block;margin:0 12px 8px 0">補線／調整頂點／儲存修正</a><select id="map" aria-label="地圖"><option value="nanzih">楠梓 1–89</option><option value="chiaotou">橋頭 90–148</option><option value="tzuguan">梓官 149–213</option></select><label>放大 <select id="zoom"><option value="100">100%</option><option value="150">150%</option><option value="200">200%</option><option value="300">300%</option></select></label><label><input id="overlay" type="checkbox" checked>候選邊界</label><label><input id="anchors" type="checkbox" checked>編號位置</label><div id="detail" aria-live="polite">點選色塊查看配對編號與問題。</div></header>
